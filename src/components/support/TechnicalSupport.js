                ...
                <div className="row justify-content-between">
                    <div className="col-xl-5 col-lg-5 col-md-12 order-1 order-lg-0">
                        <div className="testimonial-tab-slider-wrap mt-5">
                            <h1 className="fw-bold text-white display-5">Technical Support</h1>
                            ...
                            <form action="#" className="register-form">
                                <div className="row">
                                    ...
                                    <div className="col-12">
                                        <div className="input-group mb-3">
                                            <textarea className="form-control" placeholder="Tell us about your problems" style={{height: '120px'}}></textarea>
                                        </div>
                                    </div>
                                    <div className="col-12">
