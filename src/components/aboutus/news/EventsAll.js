...
function EventsAll() {
  return (
    <>
        <Headerbd/>
             <section className="page-header position-relative overflow-hidden ptb-120 pb-40 bg-dark">
                <div className="container">
                    <div className="row">
                        <div className="col-md-7">
                            <h1>Simulanis events</h1>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and </p>
                        </div>
                    </div>
                </div>
            </section>
             <section className="masonary-blog-section ptb-40 bg-light-subtitle">
                <div className="container">
                    <div className="row">
